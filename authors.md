...
- **European Partnership on Metrology**. Funder.  
  ...
  Europe Research and Innovation Programme, EURAMET, and the
  Participating States. Views and opinions expressed are those of the
  authors and do not necessarily reflect those of the European Union or
  EURAMET.

- **Translational Sensory and Circadian Neuroscience Unit
  (MPS/TUM/TUMCREATE)**. Copyright holder.  
  www.tscnlab.org

## Citation

Zauner J, Spitschan M (2026). *melidosData: Load data from the MeLiDos
field study*. R package version 1.0.3,
